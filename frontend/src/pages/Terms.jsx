...
const Terms = () => {
  return (
    <div className="">
      <h1 className="font-bold px-5 py-5 flex">Terms & Conditions</h1>
      <p className="px-10">1.
...
ASHOK PAPAER PRODUCTS
, a company incorporated under the 
Companies Act, 1956 with its registered office at PLOT NO W-32, AMRAVATI MIDC ,
...
into a legally binding and enforceable contract with the Platform Owner for the Services..</p>
<p className="px-28">10.
