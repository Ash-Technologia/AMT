...
const Privacy = () => {
  return (
    <div className="page-container">
      <h1 className="font-bold py-10 px-10">Privacy Policy</h1>
      <p className="px-10 mb-10"> Introduction
This Privacy Policy describes how ASHOK PAPAER PRODUCTS and its affiliates (collectively "
ASHOK PAPAER PRODUCTS, we, our, us") collect, use, share, protect or otherwise process your
information/ personal data through our website https://amt-health.vercel.app/ (hereinafter referred to as
...
the terms and conditions of this Privacy Policy, the Terms of Use and the applicable service/product
terms and conditions, and agree to be governed by the laws of India including but not limited to the laws
applicable to data protection and privacy. If you do not agree please do not use or access our Platform.
...
any information. If you receive an email, a call from a person/association claiming to be ASHOK
PAPAER PRODUCTS seeking any personal data like debit/credit card PIN, net-banking or mobile
