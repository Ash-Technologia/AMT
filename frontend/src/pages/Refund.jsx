...
const Refund = () => {
  return (
    <div className="page-container">
      <h1 className="font-bold p-10">Refund & Cancellation Policy</h1>
      <p className="px-10">  This refund and cancellation policy outlines how you can cancel or seek a refund for a product / service
...
product is out for delivery. In such an event, you may choose to reject the product at the doorstep.
      ...
      <p className="px-20"> 2.  
ASHOK PAPAER PRODUCTS does not accept cancellation requests for perishable items like
...
7 days
 for the 
refund to be processed to you. </p>
    </div>
  );
};
